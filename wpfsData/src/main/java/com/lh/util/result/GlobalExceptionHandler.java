...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResultUtil bizExceptionHandler(HttpServletRequest req, BizException e) {
    ...
    public ResultUtil exceptionHandler(HttpServletRequest req, NullPointerException e) {
        ...
        return ResultUtil.error(CommonEnum.BODY_NOT_MATCH);
    }
    ...
    public ResultUtil exceptionHandler(HttpServletRequest req, Exception e) {
        ...
        return ResultUtil.error(CommonEnum.INTERNAL_SERVER_ERROR);
    }
}